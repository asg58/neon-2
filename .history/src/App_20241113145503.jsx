...
import { Canvas, useFrame, extend, useThree } from '@react-three/fiber'; // Zorg ervoor dat useThree wordt geïmporteerd
...
function BloomEffect({ bloomSettings }) {
  const { scene, camera, gl } = useThree(); // Gebruik useThree om toegang te krijgen tot scene, camera en gl
