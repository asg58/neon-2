...
export default function App() {
  ...
  // Laden van beschikbare lettertypen uit de map /public/fonts
  useEffect(() => {
    async function fetchFonts() {
      const fontFiles = ['gentilis_bold.typeface.json', 'helvetiker_regular.typeface.json']; // Voeg hier de lettertypebestanden toe
      setFonts(fontFiles);
  ...
  return (
    <>
      ...
      {/* Bloom settings, kleurkiezer, tekstinvoer en lettertypekiezer */}
