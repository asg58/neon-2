// components/NeonText.jsx
import React, { useEffect, useRef } from 'react';
import { extend } from '@react-three/fiber';
import * as THREE from 'three';
import { TextGeometry } from 'three/examples/jsm/geometries/TextGeometry';
import calculateDimensions from '../utils/calculateDimensions'; // Importeer de hulpfunctie
...
export default function NeonText({ text, color, font, materialType, onDimensionsChange }) {
  ...
  useEffect(() => {
    if (font && mesh.current) {
      ...
      onDimensionsChange(dimensions); // Stuur afmetingen naar App via de callback
    }
