...
export default function ControlsPanel({
  ...
  return (
    <div style={{ position: 'absolute', top: 20, left: 20, color: 'white', backgroundColor: 'rgba(0,0,0,0.5)', padding: '10px', borderRadius: '8px' }}>
      ...
      <div>
        <h4>Dimensions</h4>
        <p>Width: {dimensions.width ? dimensions.width.toFixed(2) : 'Loading...'} units</p>
        <p>Height: {dimensions.height ? dimensions.height.toFixed(2) : 'Loading...'} units</p>
        <p>Depth: {dimensions.depth ? dimensions.depth.toFixed(2) : 'Loading...'} units</p>
      </div>
    </div>
  );
}
