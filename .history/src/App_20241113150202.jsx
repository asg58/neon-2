...
function ShowroomModel({ lightIntensity, lightColor }) {
  ...
  useEffect(() => {
    // Voeg lichtbronnen toe aan de kamer
    ...
    // Schoonmaakfunctie om de lichten te verwijderen wanneer het component ontkoppeld wordt
    return () => {
...
function GlassNeonText({ text, color, intensity, font, depth, envMap, position, onClick }) {
  const mesh = useRef();
