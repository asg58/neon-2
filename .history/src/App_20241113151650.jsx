  ...
  return (
    <>
      <Canvas dpr={Math.min(window.devicePixelRatio, 2)} style={{ width: '100vw', height: '100vh' }} shadows>
        ...
        {/* Bloom-effect alleen toegepast op de tekst */}
        ...
        <div>
          ...
          <label>
            ...
            <input
              ...
              onChange={(e) => handleTextPositionChange(0, e.target.value)}
            />
          </label>
          <br />
          <label>
            ...
            <input
              ...
              onChange={(e) => handleTextPositionChange(1, e.target.value)}
            />
          </label>
          <br />
          <label>
            ...
            <input
              ...
              onChange={(e) => handleTextPositionChange(2, e.target.value)}
            />
          </label>
        </div>
        <div>
