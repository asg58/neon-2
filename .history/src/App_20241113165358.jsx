...
export default function App() {
  ...
  const [isRotating, setIsRotating] = useState(false); // State voor rotatie
  ...
  const handleRotatingToggle = () => {
    setIsRotating((prev) => !prev); // Toggle de rotatie
  };
    ...
    <>
      <Canvas style={{ width: '100vw', height: '100vh' }}>
        ...
        <GlassNeonText
          ...
          isRotating={isRotating} // Geef de rotatie-status door
        />
      </Canvas>
      ...
      {/* Toevoegen van de rotatieknop */}
      <div style={{ position: 'absolute', bottom: '20px', left: '20px' }}>
        <button onClick={handleRotatingToggle} style={{ padding: '10px', fontSize: '16px' }}>
